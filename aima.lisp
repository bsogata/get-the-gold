...
(defparameter *aima-root* (truename "C:\\Users\\Branden Ogata\\Desktop\\ICS 314\\portfolio-code\\get-the-gold\\") ; <<<<<<<< Edit this <<<<<<
...
(def-aima-system agents (utilities)
  ...
  ("agents" / "test-agents"
   ("environments" / "basic-env" "grid-env" "vacuum" "wumpus" "abcg")
   ("agents" / "agent" "vacuum" "wumpus" "a" "b" "c")
   ("algorithms" / "grid")))
